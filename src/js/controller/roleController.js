app.controller('RolesProcessController', ['$scope','$rootScope','$http', '$state','$stateParams','Upload','ngDialog', function($scope, $rootScope, $http, $state, $stateParams,Upload, ngDialog)  
{
	var uploadURL 	= "";
