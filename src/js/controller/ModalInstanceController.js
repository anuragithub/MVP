app.controller('modalControler', ['$scope', 'Upload', '$timeout','$http','$rootScope', '$state','$stateParams', function ($scope, Upload, $timeout, $http, $rootScope, $state,$stateParams) {
	...
	if($rootScope.blnMockData)
		...
		{
			uploadURL ='DataValidationCheckServlet';
		}
	//
